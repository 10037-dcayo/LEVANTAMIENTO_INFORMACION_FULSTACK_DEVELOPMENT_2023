		...
		<form name="form-update-students" action="update.php" method="POST" autocomplete="off" autocapitalize="on">
			<div class="wrap">
				<div class="first">
					...
					<input class="text" type="text" name="txt" value="<?php echo $_SESSION['user_id']; ?>"
					...
					<input id="dateofbirth" class="date" type="date" name="dateofbirth"
						...
						placeholder="aaaa-mm-dd" maxlength="10" required />
					...
					<select id="selectuserdepartamento" class="select" name="selectDepartamento" required>
						<option value="<?php echo $_SESSION['student_departamento']; ?>">
							<?php echo $_SESSION['student_departamento']; ?>
						</option>
				...
				<div class="last">
					...
					<input id="txtuserphone" class="text" type="text" name="txtphone"
						...
						title="Ingresa un número de teléfono válido." placeholder="09999XXXXX" maxlength="10"
						required />
					...
					<input id="txtuseraddress" class="text" type="text" name="txtaddress"
						value="<?php echo $_SESSION['student_address']; ?>" placeholder="Domicilio" maxlength="200"
						required />
					...
					<input id="dateuseradmission" class="date" type="date" name="dateadmission"
						value="<?php echo $_SESSION['student_admission_date']; ?>" required />
				...
				<div class="last">
					...
					<label class="label" for="txttotalhours">
						Total de Horas
						<span>
							<input id="txttotalhours" type="text" name="txttotalhours"
								value="<?php echo $_SESSION['student_horas']; ?>" readonly>
				...
				<div class="first">
					...
					<input id="txtuserhours" class="text" type="text" name="txtuserhours"
						...
						style="height: 50px; width: 200px; font-size: 16px;"
						value="<?php echo $_SESSION['student_horario']; ?>" data-expandable />
				...
				<div class="description">
					...
					<input id="txtuserdates" class="textarea" type="text" name="txtuserdates"
						...
						maxlength="20000" data-expandable />
