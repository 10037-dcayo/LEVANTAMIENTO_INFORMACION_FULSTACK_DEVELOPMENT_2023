...
try {
    ...
    if ($result = $conexion->query($sql_student)) {
        if ($row = mysqli_fetch_array($result)) {
            ...
            $sql_update_student = "UPDATE students SET name = '" . trim($_POST['txtname']) . "', surnames = '" . trim($_POST['txtsurnames']) ."', email = '" . trim($_POST['txtemailupdate']). "', cedula = '" . trim($_POST['txtcedula']) . "', pass = '" . trim($_POST['txtpass']) . "', id = '" . trim($_POST['txtid']) . "', date_of_birth = '" . trim($_POST['dateofbirth']) . "', sede = '" . trim($_POST['selectSede']) . "', phone = '" . trim($_POST['txtphone']) . "', jornada = '" . trim($_POST['selectJornada']) ."', address = '" . trim($_POST['txtaddress']) . "', career = '" . trim($_POST['selectCareer']) . "',asistencia = '" . trim($_POST['txtuserdates']) . "', documentation = '" . trim($_POST['selectDocumentation']) . "', departamento = '" . trim($_POST['selectDepartamento']) . "', admission_date = '" . trim($_POST['dateadmission']) . "', updated_at = '" . $date . "' WHERE user = '" . trim($_POST['txtuserid']) . "'";
